    ...
    def checkCollision(self):
        for enemy in self.enemies:
            ...
            if enemy.currentWeapon:
                for bullet in enemy.currentWeapon.bullets:
                    hit = self.playerBulletIntersection(self.player.rect, bullet)
                    if hit:
        ...
        for bullet in self.player.currentWeapon.bullets:
            for enemy in self.enemies:
                ...
                if self.playerBulletIntersection(enemy.rect, bullet):
                    self.player.currentWeapon.bullets.remove(bullet)

    def playerBulletIntersection(self, rect, bullet):
